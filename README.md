...
Next, install this generator:
    ...
    npm install -g generator-ngmvc-app
...
Running a generator:
    ...
    yo cafyne-app:directive my-awesome-directive
    yo cafyne-app:partial my-partial
    yo cafyne-app:service my-service
    yo cafyne-app:filter my-filter
    yo cafyne-app:module my-module
    yo cafyne-app:modal my-modal
...
Submodules allow you to more explicitly separate parts of your application.  Use the `yo cafyne-app:module my-module` command and specify a new subdirectory to place the module into.  Once you've created a submodule, running other subgenerators will now prompt you to select the module in which to place the new component.
...
* 9/06/2013 - V1.0.4 - Fixed templating issue with generated specs for `yo cafyne-app:service` subgenerator.
