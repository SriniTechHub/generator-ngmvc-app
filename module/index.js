...
ModuleGenerator.prototype.askFor = function askFor() {
    ...
    var prompts = [
        {
            name:'dir',
            message:'Please press enter to continue or Ctrl+C to exit ?',
    ...
    this.prompt(prompts, function (props) {
        ...
        this.dir = path.join('app/'+props.dir,'/');
        cb();
    }.bind(this));
};
...
ModuleGenerator.prototype.files = function files() {
    ...
    modules.push({name:_.camelize(this.name),file:path.join(this.dir.slice(4),this.name + '.js')});
